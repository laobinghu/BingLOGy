    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <form method="POST" action="{{ route('admin.posts.store') }}">
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" name="published_at" class="w-full rounded-lg border border-neutral-200 px-3 py-2 dark:border-neutral-700" value="{{ old('published_at') }}">
            </div>
